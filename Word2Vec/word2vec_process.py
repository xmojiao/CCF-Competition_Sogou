...
#    trainData_all = pd.read_csv('data_scound/train_unigram_10w.csv')
#    trainLabel_all = pd.read_csv('data_scound/trainLabel.csv',sep=' ')
...
def data_Word2Vec(trainData,trainLabel):
    n_dim=200
...
trainData,trainLabel=data_load('gender') # 'age','gender','education'
n_dim,imdb_w2v= data_Word2Vec(trainData,trainLabel) 
...
print '*************************\nSVM\n**********************' 
C=0.1 
svclf=SVC(kernel='linear',C=C)                       #%0.7939
